...
import MilkInputForm from "./MilkInputForm";
import Modal from "react-native-modal";
import CircleButton from "../CircleButton";
import { useDateTimeContext } from "../../context/DateTimeContext";

export default function MilkAddButton() {
        ...
        <View>
            ...
            <Modal isVisible={isModalVisible}
                ...
                <View style={modalStyles.container}>
                    <Text style={modalStyles.title}>ミルク登録</Text>
                    <View>
                    ...
                    <View>
                        <MilkInputForm selectTime={selectTime} toggleModal={toggleModal}/>
                    </View>
                </View>
            </Modal>
        </View>
